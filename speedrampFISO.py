...
OUT_PATH = "/Users/anas/Desktop/Editor-test/out_ramp_fastslow.mp4"
...
def speed_at(u: float) -> float:
    """
    u in [0..1]
    Fast (5x) -> Slow (1x) using half cosine:
    - u=0   (Start) => cos(0)=1    => MAX_SPEED
    - u=1   (End)   => cos(pi/2)=0 => MIN_SPEED
    """
    return MIN_SPEED + (MAX_SPEED - MIN_SPEED) * (math.cos(u * math.pi / 2) ** 2)
